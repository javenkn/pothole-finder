...
$.getJSON( "/data/data.json" , function( result ){
  ...
  for (var i = 0; i < dataArr.length; i++) {
    ...
    var convertMonth = moment.unix(unix).format("MMMM");
    monthArr.push(convertMonth);
  }
  ...
  const body = d3.select('#d3-container'); // inputs graph where ever you set the select function
